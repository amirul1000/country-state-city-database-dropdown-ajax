...
class Country extends CI_Controller{
    ...
    function save($id=-1){   
		...
		$params = array(
					 'sortname' => html_escape($this->input->post('sortname')),
'country' => html_escape($this->input->post('country')),
'phonecode' => html_escape($this->input->post('phonecode')),
...
$this->db->or_like('sortname', $key, 'both');
$this->db->or_like('country', $key, 'both');
$this->db->or_like('phonecode', $key, 'both');
...
$this->db->or_like('phonecode', $key, 'both');
	...
	function export($export_type='CSV'){
	  if($export_type=='CSV'){	
		   ...
		   $header = array("Id","Sortname","Country","Phonecode"); 
		   fputcsv($file, $header);
